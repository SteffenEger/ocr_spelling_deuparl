...
if __name__ == "__main__":
    ...
    bucket_folders = list(natsorted(glob.glob("data/3_ocr_post_corrected_spelling_normalization/Bundestag/*/")))
    ...
    for bucket_folder in tqdm.tqdm(bucket_folders):
        ...
        if not os.path.isdir(f"data/4_sliced/{slice_name}/"):
            os.makedirs(f"data/4_sliced/{slice_name}/")
        ...
        for file_path in file_paths:
            ...
            with open(f"data/4__sliced/{slice_name}/{idx_per_slice[slice_name]}.txt", "w", encoding="utf-8") as file:
                file.write(text)
